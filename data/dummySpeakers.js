    ...
    speakers: [
      {
        ...
        titles: [
          "C.P & MBA EN FINANZAS",
          "Chief of Crypto Operations at Soluciones",
          "Blockchain Mexico",
        ],
        event:
          "Web2 open finance data + Web3 smart <br /> contacts = Financial automation",
        time: "11:00",
      },
      {
...
export const speakers = [
  {
    ...
    Profesor investigador y profesor líder del programa académico de blockchain y tokenomía en el Tecnológico de Monterrey. Fundador y CEO de la Monterrey Bitcoin Embassy. 
    <br><br>
    Además, autor de los libros: 
    <br>Crypto Papers y Tokenomics: una economía tokenizada; 
    <br>El paper: 
    <br>Blockchain education: challenging the long-stanidng model of academic institutions; 
    <br>Y las tesis: 
  ...
  },
  {
    ...
    <br>Así mismo, continúa involucrado en temas de trading algorítmico en el mercado de Forex, Futuros y Criptomonedas. 
    <br><br>Su pasión por la naturaleza y la vida sostenible lo llevó a construir su casa basada en la permacultura. 
    Experto en infraestructura y seguridad que lo llevó a fundar 
    <a href='https://microbit.com' target='_blank'><i style="color:blue">microbit.com,</i></a>
     un emprendimiento tecnológico enfocado en montar 
